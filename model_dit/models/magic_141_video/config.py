...
import re
from .modules.models import MAGIC_141_VIDEO_CONFIG


def parse_args(namespace=None):
    parser = argparse.ArgumentParser(description="Magic141Video inference script")
...
def add_network_args(parser: argparse.ArgumentParser):
    group = parser.add_argument_group(title="Magic141Video network args")

    # Main model
    group.add_argument(
        "--model",
        type=str,
        choices=list(MAGIC_141_VIDEO_CONFIG.keys()),
        default="Magic_141_Video-T/2-cfgdistill",
    )
    group.add_argument(
        "--latent-channels",
        type=str,
...
def add_inference_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument(
        "--dit-weight",
        type=str,
        default="ckpts/Magic141-video-t2v-720p/transformers/mp_rank_00_model_states.pt",
        help="Path to the Magic141Video model. If None, search the model in the args.model_root."
