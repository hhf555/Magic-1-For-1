...
class AutoencoderKLCausal3D(ModelMixin, ConfigMixin, FromOriginalVAEMixin):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_path, subfolder=None, from_scratch=False, model_additional_kwargs={}):
        if subfolder is not None:
            pretrained_model_path = os.path.join(pretrained_model_path, subfolder)
        print(f"loaded Magic_141 3D VAE from {pretrained_model_path} ...")
        ...
        vae_ckpt = os.path.join(pretrained_model_path, "pytorch_model.pt")
        ...
        model.load_state_dict(vae_ckpt, strict=True)
        model.enable_tiling()
        return model
