...
from ...video_ae.ae import CausalAutoencoderOutput, CausalDecoderOutput, CausalEncoderOutput
from ...video_vae.modules.inflated_layers import (
    InflatedCausalConv3d,
    _inflation_mode_t,
    init_causal_conv3d,
)
from ...video_vae.modules.inflated_lib import MemoryState, causal_norm_wrapper, remove_head
        ...
        **kwargs,
        ...
        if self.interpolate:
            ...
            if output_size is None:
                # [Overridden] different tensor shape.
                hidden_states = F.interpolate(
                    hidden_states,
                    scale_factor=(self.temporal_ratio, self.spatial_ratio, self.spatial_ratio),
                    mode="nearest",
                )
            else:
